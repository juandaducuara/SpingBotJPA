...
public class Serie {
    ...
    private Long Id;
    //Anotacion para identificar que cada valor es unico
    @Column(unique = true)
    private String titulo;
    private Integer totalTemporadas;
    private Double evaluacion;
    private String poster;
    //Anotacion para reconocer que es de tipo ENUM
    ...
    public Serie(DatosSerie datosSerie){
        ...
        //Optinal útil para manejar valores que pueden estar presentes o ausentes , con validacion
    ...
    //Metodo to string para imprimir las varibles necesarias
    @Override
